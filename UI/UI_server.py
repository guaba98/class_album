...
class Ui_server_form(object):
    def setupUi(self, server_form):
        ...
        server_form.setStyleSheet("background-color: rgb(255, 255, 255);")
        ...
        self.server_title_lab.setStyleSheet("color: rgb(47, 128, 237);")
        ...
        self.host_ip_lab.setStyleSheet("color: rgb(47, 128, 237);")
        ...
        self.connected_info_lab.setStyleSheet("color: rgb(47, 128, 237);")
        ...
        self.send_btn.setStyleSheet("background-color: rgb(47, 128, 237);\n"
...
"border-radius: 7px;")
        ...
        self.host_port_lineedit.setFont(font)
        self.host_port_lineedit.setStyleSheet("border-radius:7px;\n"
...
"")
        ...
        self.host_port_lab.setStyleSheet("color: rgb(47, 128, 237);")
        ...
        font.setFamily("나눔스퀘어 네오 Regular")
        font.setPointSize(10)
        self.host_ip_lineedit.setFont(font)
        self.host_ip_lineedit.setStyleSheet("border-radius:7px;\n"
"border: 2px solid #2F80ED;")
        ...
        font.setFamily("나눔스퀘어 네오 Bold")
        font.setPointSize(11)
        self.server_start_btn.setFont(font)
        self.server_start_btn.setStyleSheet("background-color: rgb(47, 128, 237);\n"
"color: rgb(255, 255, 255);\n"
"border: 2px solid white;\n"
"border-radius: 7px;")
        ...
        self.chat_lineedit.setStyleSheet("border-radius:7px;\n"
"border: 2px solid #2F80ED;")
        ...
        self.notice_comments_lab.setStyleSheet("color: rgb(47, 128, 237);")
        ...
        font.setFamily("나눔스퀘어 네오 Regular")
        font.setPointSize(10)
        self.chat_listwidget.setFont(font)
        self.chat_listwidget.setStyleSheet("border-radius:7px;\n"
"border: 2px solid #2F80ED;")
